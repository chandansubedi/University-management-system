...
urlpatterns = [
    ...
    path('staff_detail/<staff_id>/', HodViews.staff_detail, name="staff_detail"),
    path('course_staff_list/<course_id>/', HodViews.course_staff_list, name="course_staff_list"),
    ...
    path('student_detail/<student_id>/', HodViews.student_detail, name="student_detail"),
    path('course_student_list/<course_id>/', HodViews.course_student_list, name="course_student_list"),
    path('delete_student/<student_id>/', HodViews.delete_student, name="delete_student"),
    path('add_subject/', HodViews.add_subject, name="add_subject"),
    path('add_subject_save/', HodViews.add_subject_save, name="add_subject_save"),
    path('manage_subject/', HodViews.manage_subject, name="manage_subject"),
    path('subject_detail/<subject_id>/', HodViews.subject_detail, name="subject_detail"),
    path('course_subject_list/<course_id>/', HodViews.course_subject_list, name="course_subject_list"),
    ...
    path('staff_download_attendance_csv/', StaffViews.staff_download_attendance_csv, name="staff_download_attendance_csv"),
    path('staff_download_attendance_csv_get/', StaffViews.staff_download_attendance_csv_get, name="staff_download_attendance_csv_get"),
    path('staff_download_attendance_monthly/', StaffViews.staff_download_attendance_monthly, name="staff_download_attendance_monthly"),
